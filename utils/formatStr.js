...
const convertToStartCase = (words) =>
  words &&
  words
    .split(' ')
...
const formatCityStr = (str) =>
  str.length <= 12 ? str : `${str.slice(0, 12)}..`;
...
export {
  validInputs as _vi,
  trimStr as _trimStr,
  convertToStartCase as _ctsc,
  coverToKebabCase as _ctkc,
  formatCityStr as _fcs,
  formatDate as _fd,
  formatDateOnEdit as _fdoe,
};
